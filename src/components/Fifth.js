            ...
            <div className='containProjects'>
                ...
                <div className='parent1 parent' data-aos="fade-right" data-aos-offset="100" data-aos-duration="2000" data-aos-once="true">
                    <div className='overlay'>
                        ...
                        <div class='codeButtons'>
                            <h2><a href='https://github.com/Joe-Powell/WeatherApp' target='_blank' rel="noopener noreferrer">See Code</a></h2>
                            <h2><a href='http://joe-powell.com/WeatherApp/' target='_blank' rel="noopener noreferrer">Live Project</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className='parent2 parent' data-aos="fade-left" data-aos-offset="100" data-aos-duration="2000" data-aos-once="true">
                    ...
                    <div className='overlay'>
                        ...
                        <div class='codeButtons'>
                            <h2><a href='https://github.com/Joe-Powell/Login_Project_With_Posts' target='_blank' rel="noopener noreferrer">See Code</a></h2>
                            <h2><a href='http://myblogs.live/loginSocialMediaPosts' target='_blank' rel="noopener noreferrer">Live Project</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className='parent3 parent ' data-aos="fade-right" data-aos-offset="100" data-aos-duration="2000" data-aos-once="true">
                    <div className='overlay'>
                        <h4>In his project you can add items to cart, remove them, get the total price and to calculate the quantity. Technologies are Javascript, local storage,
                            HTML, and CSS. </h4>
                        <div class='codeButtons'>
                            <h2><a href='https://github.com/Joe-Powell/shopping-cart-2020' target='_blank' rel="noopener noreferrer">See Code</a></h2>
                            <h2><a href='http://joe-powell.com/shoppingCartSupplements/' target='_blank' rel="noopener noreferrer">Live Project</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className='parent4 parent' data-aos="fade-left" data-aos-offset="100" data-aos-duration="2000" data-aos-once="true">
                    <div className='overlay'>
                        ...
                        <div class='codeButtons'>
                            <h2><a href='https://github.com/Joe-Powell/nodeExpressMongoFetch' target='_blank' rel="noopener noreferrer">See Code</a></h2>
                            <h2><a href='https://murmuring-badlands-94908.herokuapp.com/' target='_blank' rel="noopener noreferrer">Live Project</a></h2>
                        </div>
                    </div>
                </div>
            </div>
